...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Experienced Full Stack Developer</span> with over <span className="text-work_experience_orange">3 years</span> of experience in the software industry.
        </div>
      ),
    },
  ...
  },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-skills_purple">Full Stack</span> web developer with experience in <span className="text-skills_purple">Front-End</span> and{' '}
  ...
  // },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          Let&apos;s <span className="text-blue-400">work together</span> and build a <span className="text-blue-400">strong business relationship.</span>
        </div>
      ),
    },
